...
//	 SPACE, SPACE, HOSPITAL, PIONT_50, SPACE } };
	...
	protected int[][] land1 = {
			// 模仿大富翁其中一个地图设置
			{ ORIGIN, SPACE, HOSPITAL, PIONT_50, SHOP, PRISON, SPACE, PARK},
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,PIONT_30 },
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,SPACE },
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,SPACE },
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,SPACE },
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,SPACE },
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET,  NULL_SET, NULL_SET,SPACE },
